...
BEGIN {
    ...
    require '/workspaces/Coding/openssl-openssl-3.0.5/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/workspaces/Coding/openssl-openssl-3.0.5/test/fips-and-base.cnf';
    shift;
