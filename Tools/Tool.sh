...
CodeforcesUsername=$(cat /workspaces/Coding/Keys/CodeforcesUsername);
CodeforcesPassword=$(cat /workspaces/Coding/Keys/CodeforcesPassword);
...
elif echo "$1" | grep "Codeforces" > /dev/null
then
    /workspaces/Coding/Tools/Tool Codeforces $CodeforcesUsername $CodeforcesPassword $2 ${1:30:-4}
else
