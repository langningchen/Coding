...
#define OUTPUT_IF_FAILED(NewResult)                    \
    {                                                  \
        ...
        if (!_Result.Success)                          \
            std::cout << _Result.Message << std::endl; \
    }
...
#define RETURN_IF_FAILED(NewResult)                                                                                                         \
    {                                                                                                                                       \
        RESULT _Result = (NewResult);                                                                                                       \
        if (!_Result.Success)                                                                                                               \
            return RESULT(_Result.Success, _Result.Message + __FILE__ + ":" + std::to_string(__LINE__) + " " + __PRETTY_FUNCTION__ + "\n"); \
    }
